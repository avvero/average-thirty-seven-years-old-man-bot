...
func (this Whitelist) Check(chatId int64) (has bool, message string) {
	if !utils.Contains([]string{"0", "-1001733786877", "245851441", "-578279468"}, strconv.FormatInt(chatId, 10)) {
		return false, "Mr Moony presents his compliments to Professor Snape, and begs him to keep his " +
